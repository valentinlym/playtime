...
<body class="n900">
    ...
    <nav class="mobile fb fb-sa">
        <a class="home active" href="apphome.html">
            <img src="../src/icons/act-home.svg" alt="home icon">
        </a>
        <a href="appresearch.html">
            <img src="../src/icons/research.svg" alt="esearch icon">
        </a>
        <a href="appuser.html">
            <img src="../src/icons/user.svg" alt="user icon">
        </a>
    </nav>
            ...
            <div class="gcta">
                <div class="gstatus">
                    <div class="gstatus_content">
                        <img src="../src/icons/eye-open.svg" alt="eye open icon">
                        <span class="text-sm text-p500">En vue</span>
                    </div>
                </div>
                <div class="gstatus">
                    <div class="gstatus_content">
                        <img src="../src/icons/rocket.svg" alt="rocket icon">
                        <span class="text-sm text-p500">En cours</span>
                    </div>
                </div>
                <div class="gstatus">
                    <div class="gstatus_content">
                        <img src="../src/icons/done.svg" alt="rocket icon">
                    ...
                    <div class="ltable">
                        ...
                        <div class="tbody">
                            ...
                            <div class="lrow">
                                ...
                                <div class="text">
                                    <img src="../src/icons/done--dark.svg" alt="close icon">
                                </div>
                                <div class="audio">
                                    <img src="../src/icons/done--dark.svg" alt="done icon">
                                </div>
                            </div>
                            <div class="lrow">
                                ...
                                <div class="audio">
                                    <img src="../src/icons/close.svg" alt="done icon">
                                </div>
                            </div>
                            <div class="lrow">
