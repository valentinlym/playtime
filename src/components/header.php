...
<nav class="mobile fb fb-sa">
    <a href="apphome.php">
        <img src="../../assets/icons/<?php if($title=="home"){ echo "act-";}else{echo "";}?>home.svg" alt="home icon">
    </a>
    <a href="appresearch.php">
        <img src="../../assets/icons/<?php if($title=="research"){ echo "act-";}else{echo "";}?>research.svg" alt="esearch icon">
    </a>
    <a href="appuser.php">
        <img src="../../assets/icons/<?php if($title=="user"){ echo "act-";}else{echo "";}?>user.svg" alt="user icon">
    </a>
</nav>