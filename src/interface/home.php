        ...
        <div class="illu">
            <div class="slider">
                <div class="slider__container">
                    <img src="../../assets/img/cover_3.jpg" class="cover">
                    <img src="../../assets/img/cover_4.jpg"  class="cover">
                    <img src="../../assets/img/cover_1.jpg"  class="cover">
                    <img src="../../assets/img/cover_2.jpg"  class="cover">
                    <img src="../../assets/img/cover_3.jpg"  class="cover">
                    <img src="../../assets/img/cover_4.jpg"  class="cover">
                    <img src="../../assets/img/cover_1.jpg"  class="cover">
                    <img src="../../assets/img/cover_2.jpg"  class="cover">
